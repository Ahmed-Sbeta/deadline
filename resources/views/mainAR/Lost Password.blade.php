											...
											<ul class="nav nav-pills" id="mainNav">
												<li class="nav-item dropdown nav-item-left-border d-none d-sm-block nav-item-left-border-remove nav-item-left-border-md-show">
													...
													<div class="dropdown-menu" aria-labelledby="dropdownLanguage">
														<a class="dropdown-item" href="/مشروع التخرج/Deadline/Deadline/dist/Home - En/Lost Password.html"> EN</a>
													</div>
												</li>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">إستعادة كلمة المرور</h1>
							</div>
						...
						<div class="col-md-12">
							<div class="featured-box featured-box-primary text-end mt-0" >
								<div class="box-content">
									<h4 class="color-primary font-weight-semibold text-4 text-uppercase mb-0" >استعادة كلمة المرور </h4>
									<p class="text-2 opacity-7">قم بإدخال بريدك الإلكتروني حتى تستعيد كلمة المرور الخاصة بك</p>
									<form action="/" id="frmLostPassword" method="post" class="needs-validation" dir="rtl">
										<div class="row">
										...
										<div class="row">
											<div class="form-group col">
												<input type="submit" value="إرسال" class="btn btn-primary btn-modern float-end" data-loading-text="Loading...">
											</div>
										</div>
									</form>
								</div>
