			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">الدخول</h1>
							</div>
				...
				<div class="container py-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-12">
							<h2 class="font-weight-bold text-5 mb-0" dir="rtl">دخول</h2>
							<form action="/" id="frmSignIn" method="post" class="needs-validation" dir="rtl">
								<div class="row">
									<div class="form-group col">
										<label class="form-label text-color-dark text-3" dir="rtl">البريد الإلكتروني <span class="text-color-danger">*</span></label>
										<input type="email" value="" class="form-control form-control-lg text-4" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col">
										<label class="form-label text-color-dark text-3">كلمة المرور <span class="text-color-danger">*</span></label>
								...
								<div class="row">
									<div class="form-group col-md-3">
										<button type="submit" class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3" data-loading-text="Loading...">دخول</button>
