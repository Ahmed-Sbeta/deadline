			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">التسجيل</h1>
							</div>
							<div class="col-md-12 align-self-center order-1">
								<ul class="breadcrumb d-block text-center">
									<li><a href="index-corporate.html">الرئيسية</a></li>
				...
				<div class="container py-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-12">
							<h2 dir="rtl" class="font-weight-bold text-5 mb-0">كود الشركة <span class="text-color-danger">*</span></h2>
							<br>
							<form action="/" id="frmSignIn" method="post" class="needs-validation" dir="rtl">
								<div class="card mb-4">
									<div class="card-body">
										<input class="form-control form-control-lg mb-3" type="text" placeholder="أدخل الكود الخاص بالشركة" required>
								...
								<div class="row">
									<div class="form-group col">
										...
										<input type="text" value="" class="form-control form-control-lg text-4" placeholder="على سبيل المثال .. مصمم جرافيك أو مصور" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col">
								...
								<div class="row justify-content-between">
									<div class="form-group col-md-auto">
										<div class="custom-control custom-checkbox">
											...
											<label class="form-label custom-control-label cur-pointer text-2" for="rememberme">تذكرني</label>
										</div>
									</div>
