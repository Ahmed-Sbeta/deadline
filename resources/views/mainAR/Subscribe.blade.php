											...
											<ul class="nav nav-pills" id="mainNav">
												<li class="nav-item dropdown nav-item-left-border d-none d-sm-block nav-item-left-border-remove nav-item-left-border-md-show">
													...
													<div class="dropdown-menu" aria-labelledby="dropdownLanguage">
														<a class="dropdown-item" href="/مشروع التخرج/Deadline/Deadline/dist/Home - En/Subscribe.html"> EN</a>
													</div>
												</li>
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">الإشتراك</h1>
							</div>
				...
				<div class="container py-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-12">
							<h2 class="font-weight-bold text-5 mb-0" dir="rtl">إسم الشركة <span class="text-color-danger">*</span></h2>
							<br>
							<form action="/" id="frmSignIn" method="post" class="needs-validation" dir="rtl">
								<div class="card mb-4">
									<div class="card-body">
										<input class="form-control form-control-lg mb-3" type="text" placeholder="أدخل إسم الشركة" required>

									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label text-color-dark text-3">الإسم الأول <span class="text-color-danger">*</span></label>
										<input type="text" value="" class="form-control form-control-lg text-4" required>
									</div>
									<div class="form-group col-md-6">
										<label class="form-label text-color-dark text-3">اللقب <span class="text-color-danger">*</span></label>
										<input type="text" value="" class="form-control form-control-lg text-4" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col">
										<label class="form-label text-color-dark text-3">تاريخ الميلاد<span class="text-color-danger">*</span></label>
										<input type="date" value="" class="form-control form-control-lg text-4" required>
									</div>
								</div>

								<div class="row">
									<div class="form-group col">
										<label class="form-label text-color-dark text-3">البريد الإلكتروني <span class="text-color-danger">*</span></label>
										<input type="email" value="" class="form-control form-control-lg text-4" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-lg-6">
										<label class="form-label">كلمة المرور <span class="text-color-danger">*</span></label>
										<input type="password" name="password" value="" class="form-control form-control-lg" required>
									</div>
									<div class="form-group col-lg-6">
										<label class="form-label">تأكيد كلمة المرور <span class="text-color-danger">*</span></label>
										<input type="password" name="confirmPassword" value="" class="form-control form-control-lg" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-lg-6">
										<label class="form-label">رقم الهاتف <span class="text-color-danger">*</span></label>
										<input type="tel" value="" class="form-control form-control-lg"  required>
									</div>
									<div class="form-group col-lg-6">
								...
								<div class="row">
									<div class="form-group col">
										<label class="form-label">الباقة <span class="text-color-danger">*</span></label>
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input class="form-check-input" type="radio" name="radios" data-msg-required="الرجاء اختيار خيار واحد فقط " id="tabContent9Radio1" value="option1" required> الأساسية
											</label>
										</div>
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input class="form-check-input" type="radio" name="radios" data-msg-required="الرجاء اختيار خيار واحد فقط" id="tabContent9Radio2" value="option2" required> العادية
											</label>
										</div>
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input class="form-check-input" type="radio" name="radios" data-msg-required="الرجاء اختيار خيار واحد فقط" id="tabContent9Radio3" value="option3" required> الاحترافية
											</label>
										</div>
									</div>
								</div>
								<div class="alert alert-warning" dir="rtl">
									<strong>الرجاء الإنتباه</strong> يجب عليك أن تتم عملية الدفع بعد الانتهاء من عملية التسجيل حتى تتمكن من استلام <strong> كود الشركة</strong>
								</div>

								<div class="row">
									<div class="form-group col-md-3">
										<button type="submit" class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3" data-loading-text="Loading...">تسجيل</button>
				...
				<div class="container py-4">
					<div class="row justify-content-md-center py-5 mt-3">
						...
						<div class="col-md-6 col-lg-5 text-center text-lg-start">
							<h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4" dir="rtl">أخر الأخبار</h5>
							<div class="alert alert-success d-none" id="newsletterSuccess">
								<strong>تمت العملية بنجاح</strong> تم إضافتك الى قائمة اخر الاخبار
							</div>
