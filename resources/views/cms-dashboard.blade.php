                ...
                <div class="border-bottom-2 py-32pt position-relative z-1">
                    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                        ...
                        <div class="row"
                            ...
                            <div class="col-auto border-left">
                                <a href=""
                                   class="btn btn-accent">New Post</a>
                            </div>
                        </div>
                ...
                <div class="container-fluid page__container page__container page-section">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex">
                                            <h5 class="card-title m-0"><a href=""
                                                   class="headings-color">Cheap Romantic Vacations</a></h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mb-8pt">
                                        ...
                                        <div class="flex d-flex flex-column">
                                            <h5 class="card-title m-0"><a href=""
                                                   class="headings-color">Copper Canyon</a></h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="mr-8pt">
                                            <div class="avatar avatar-sm avatar-4by3">
                                                <img src="assets/images/stories/256_rsz_rhema-kallianpur-275251-unsplash.jpg"
                                                     alt="Avatar"
                                                     class="avatar-img rounded">
                                            </div>
                                        </div>
                                        <div class="flex d-flex flex-column">
                                            <h5 class="card-title m-0"><a href=""
                                                   class="headings-color">Selecting The Right Hotel</a></h5>
                                            <small class="text-50">78 views this week</small>
                                        </div>
                                    </div>
                    ...
                    <div class="posts-cards mb-24pt">
                        ...
                        <div class="card posts-card">
                            <div class="posts-card__content d-flex align-items-center flex-wrap">
                                <div class="avatar avatar-lg mr-3">
                                    <a href=""><img src="assets/images/stories/256_rsz_clem-onojeghuo-193397-unsplash.jpg"
                                             alt="avatar"
                        ...
                        <div class="card posts-card">
                            <div class="posts-card__content d-flex align-items-center flex-wrap">
                                <div class="avatar avatar-lg mr-3">
                                    <a href=""><img src="assets/images/stories/256_rsz_dex-ezekiel-761373-unsplash.jpg"
                                             alt="avatar"
                                             class="avatar-img rounded"></a>
                                </div>
                                <div class="posts-card__title flex d-flex flex-column">
                        ...
                        <div class="card posts-card">
                            <div class="posts-card__content d-flex align-items-center flex-wrap">
                                <div class="avatar avatar-lg mr-3">
                                    <a href=""><img src="assets/images/stories/256_rsz_rhema-kallianpur-275251-unsplash.jpg"
                                             alt="avatar"
                                             class="avatar-img rounded"></a>
                                </div>
                                <div class="posts-card__title flex d-flex flex-column">
            ...
            <div class="mdk-drawer js-mdk-drawer"
                ...
                <div class="mdk-drawer__content">
                    <div class="sidebar sidebar-dark sidebar-left"
                        ...
                        <!-- Navbar toggler -->
                        <a href="compact-cms-dashboard.html"
