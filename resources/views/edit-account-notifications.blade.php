                                        ...
                                        <div class="list-group-item">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label"
                                                       for="customCheck1">Huma Newsletter</label>
                                        ...
                                        <div class="list-group-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       id="customCheck2">
                                                <label class="custom-control-label"
                                                       for="customCheck2">New Content Releases</label>
                                        ...
                                        <div class="list-group-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       id="customCheck3">
                                                <label class="custom-control-label"
                                                       for="customCheck3">Product &amp; Feature Updates</label>
                                        ...
                                        <div class="list-group-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       id="customCheck4">
                                                <label class="custom-control-label"
                                                       for="customCheck4">Emails from Teachers</label>
                                        ...
                                        <div class="list-group-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       id="customCheck5">
                                                <label class="custom-control-label"
                                                       for="customCheck5">Content Suggestions</label>
