                            ...
                            <div class="nav-item dropdown d-none d-sm-flex" >
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item"
                                       href="/مشروع التخرج/Deadline/Deadline/dist/Ar/index.html">العربية</a>
                                           ...
                                           <td>
                                               ...
                                               <div class="media flex-nowrap align-items-center"
                                                   ...
                                                   <div class="media-body">
                                                       <div class="d-flex flex-column">
                                                           <small class="js-lists-values-project"><strong><a href="project-details.html">{{$project->title}}</a> </strong></small>
                                       ...
                                       <tr>
                                           <td>
                                               ...
                                               <div class="media flex-nowrap align-items-center"
                                                   ...
                                                   <div class="media-body">
                                                       <div class="d-flex flex-column">
                                                           <small class="js-lists-values-project"><strong><a href="project-details.html">{{$archiv->title}}</a> </strong></small>
                                                           <small class="js-lists-values-location text-50"></small>
                                                       </div>
                                                   </div>
                                               </div>
