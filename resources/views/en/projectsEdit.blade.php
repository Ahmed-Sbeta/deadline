                     ...
                     <div class="page-section">
                       ...
                       @endif
                         <div class="page-separator">
                             <div class="page-separator__text">Edit Project</div>
                         </div>
                         <form class="" action="{{url('/editproject/'.$proj->id)}}" method="POST" enctype="multipart/form-data">
                          @csrf
                          @method('PATCH')
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-md-9">
                                             <textarea id="question"
                                                       rows="1"
                                                       class="form-control"
                                                         name="title">{{$proj->title}}</textarea>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                             ...
                             <div class="list-group-item">
                                 <div role="group"
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-md-9">
                                             <input type="date" name="dueOn" value="{{$proj->dueOn}}">
                                         </div>
                                     </div>
                                 </div>
                             </div>
                                         ...
                                         <label id="label-topic"
                                                ...
                                                <div class="col-9">
                                                    <select class="contributors form-control multiple-select" name="contributors[]" multiple="multiple">
                                                      @foreach($users_proj as $userss)
                                                      @foreach($users as $user)
                                                      @if($userss->user_id == $user->id)
