                  ...
                  <div class="nav-item dropdown d-none d-sm-flex" >
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a class="dropdown-item"
                             href="/مشروع التخرج/Deadline/Deadline/dist/En/user-approves.html">EN</a>
              ...
              <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                  <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                   ...
                   <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                       <h2 class="mb-0">طلبات المستخدمين </h2>
                                  ...
                                  <div class="card-header d-flex align-items-center">
                                      <div class="flatpickr-wrapper flex">
                                          <div id="recent_orders_date"
                                              ...
                                              <strong class="d-block">الطلبات الحديثة</strong>
