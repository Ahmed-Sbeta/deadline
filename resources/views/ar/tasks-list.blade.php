                      ...
                      <div class="nav-item dropdown d-none d-sm-flex" >
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                              ...
                              <a class="dropdown-item"
                                 href="/مشروع التخرج/Deadline/Deadline/dist/En/tasks-list.html">EN</a>
                                ...
                                <table class="table mb-0 thead-border-top-0 table-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 100px;">المشروع المختص</th>
                                            <th style="width: 48px;">
                                                تاريخ الانتهاء
                                            </th>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           ...
                                                           checked=""
                                                           id="customCheck1_tasks_1">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks_1"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks_2">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks_2"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks_3">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks_3"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks_4">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks_4"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <strong class="flex js-lists-values-name">Add Fluid Layout Featuring A Vertical Menu</strong>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks2_1">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks2_1"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks2_2">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks2_2"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <a href="reminders.html"
                                                   class="text-50"><i class="material-icons">notifications</i>
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks2_3">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks2_3"><span class="text-hide">Check</span></label>
                                                </div>
                                            </td>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-lg-0">
                                ...
                                <div class="card-body">
                                    <div>
                                        <a href="tasks-board.html"><img src="assets/images/quickers.png" alt="Project Details"
                            ...
                            <div class="bg-dark rounded page-section py-lg-32pt px-16pt px-lg-24pt">
                                <div class="row">
                                    <div class="col-md-2 col-sm-4 mb-24pt mb-md-0">
                                        <p class="text-white-70 mb-8pt"><strong>تابعونا</strong></p>
                                    ...
                                    <div class="col-md-4 text-md-right">
                                       <p></p><p></p>
                                        <p class="text-white-50 small mb-0">موجة 2022 &copy; جميع الحقوق محفوظة.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
