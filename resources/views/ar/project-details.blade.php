                   ...
                   <div class="nav-item dropdown d-none d-sm-flex" >
                       ...
                       <div class="dropdown-menu dropdown-menu-right">
                           ...
                           <a class="dropdown-item"
                              href="/مشروع التخرج/Deadline/Deadline/dist/En/project-details.html">EN</a>
                    ...
                    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                         ...
                         <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                             <h2 class="mb-0"> تفاصيل المشروع</h2>
                    ...
                    <div class="page-section">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <h1 class="h3 mb-2">Creating a new social media page with new identity</h1>
                                      ...
                                      <span class="avatar avatar-32pt avatar  mr-12pt">
                                        ...
                                        <div class="flex">
                                            <p class="d-flex align-items-center mb-2">
                                                  <span class="text-body mr-2"><strong>Jenell D. Matney</strong></span>
                                            ...
                                            <div class="d-flex align-items-center">
                                                    <a href="#"
                                                       class="btn btn-sm btn-outline-secondary">تحميل المرفقات<i class="icon--right material-icons">file_download</i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <button class="btn btn-accent">أضف رد</button>
                                    </div>
                                </div>
                                <div class="pt-3">
                                    <h4>التعليقات</h4>
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="flex">
                                             <span class="text-body"><strong>Joseph S. Ferland</strong></span>
                                            <span class="text-70">How can I load Charts on a page?<br>How can I load Charts on a page?</span>
                                            <div class="d-flex align-items-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <h5 class="text-70">الفريق المشارك</h5>
                                <p class="text-70 mb-24pt">أعضاء الفريق الذين سيعملون على ها المشروع ، حظ موفق</p>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                           ...
                                           <span class="flex mr-2 text-body"><strong>Luci Bryant</strong></span>
                                    </div>
