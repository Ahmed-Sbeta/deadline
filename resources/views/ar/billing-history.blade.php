                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="flex"
                                                ...
                                                <small class="text-100">
                                                    يرجى تسديد القيمة
                                                    <strong>&dollar;9.00</strong>للفاتورة رقم <a href="billing-invoice.html"
                                                       class="text-underline">10002331</a>
                                                </small>
                                            </div>
                                            <a href="billing-payment.html"
                                               class="btn btn-sm btn-link">إدفع الأن</a>
                                        </div>
                                    </div>

                                    <div class="page-separator">
                                        <div class="page-separator__text"> المدفوعات السابقة</div>
                                    </div>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="d-inline-flex align-items-center">
                                                            <a href="billing-invoice.html"
                                                               class="btn btn-sm btn-outline-secondary mr-16pt">عرض الفاتورة <i class="icon--right material-icons">keyboard_arrow_right</i></a>
                                                            <a href="billing-invoice.html"
                                                               class="btn btn-sm btn-outline-secondary">تنزيل <i class="icon--right material-icons">file_download</i></a>
                                                        </div>
                                                    </td>
                                                </tr>
