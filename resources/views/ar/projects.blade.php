                ...
                <div class="nav-item dropdown d-none d-sm-flex" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item"
                           href="/مشروع التخرج/Deadline/Deadline/dist/En/projects.html">EN</a>
          ...
          <div class="container-fluid page__container">
              <div class="page-section">
                  ...
                  <div class="page-separator">
                      <div class="page-separator__text">ملخص</div>
                  </div>
                      ...
                      <div class="d-flex flex-wrap align-items-start">
                          ...
                          <div class="flex"
                              ...
                              <small class="text-100">
                                  ...
                                  <span>UPCOMING DEADLINE : LIBYANA VIDEO PRODUCTION, <a href="project-details.html"> اضغط هنا </a></span>
                              </small>
                          </div>
                      </div>
                  </div>
                              ...
                              <div class="card-body d-flex flex-column justify-content-center">
                                  ...
                                  <div class="mb-8pt">
                                      <p class="d-flex align-items-center mb-4pt">
                                          ...
                                          <small class="text-50 lh-24pt">ينتهي خلال 12 يوم</small>
                                      </p>
                                      <div class="progress"
                                           style="height: 4px;">
                                  ...
                                  <div>
                                      <p class="d-flex align-items-center mb-4pt">
                                          ...
                                          <small class="text-50 lh-24pt">ينتهي خلال 30 يوم</small>
                                      </p>
                                      <div class="progress"
                                           style="height: 4px;">
                              ...
                              <div class="card-header d-flex">
                                  <div class="flex d-flex align-items-center">
                                      ...
                                      <div class="d-flex flex-column">
                                          <p class="mb-0"><strong>مشرفين المشاريع</strong></p>
                                          <small class="text-50">تواصل مع المشرفين</small>
                                      </div>
                                  </div>
                              </div>
                  ...
                  <div class="page-separator">
                      <div class="page-separator__text">المشاريع النشطة</div>
                  </div>
                  ...
                  <div class="card dashboard-area-tabs mb-32pt" id="project_details">
                                 ...
                                 <div class="col-auto">
                                     <span
                                        ...
                                        class=" card-body d-flex flex-row align-items-center justify-content-start">
                                         ...
                                         <span class="flex d-flex flex-column">
                                             <strong>نشطة</strong>
                                             <small class="text-50">مشاريع الحالية</small>
                                         </span>
                                         </span>
                                 </div>
                             </div>
                                  ...
                                  <div class="d-inline-flex align-items-center">
                                      <a href="#"
                                         class="btn btn-sm btn-outline-secondary mr-16pt">بحث  <i class="icon--right material-icons">keyboard_arrow_left</i></a>
                      ...
                      <div class="card-footer p-8pt">
                          ...
                          <ul class="pagination justify-content-start pagination-xsm m-0">
                              ...
                              <div class="col-auto border-left" style="margin-right: auto">
                                  <a href="#"
                                     class="btn btn-accent">تـــم</a>
                              </div>
                          </ul>
                  ...
                  <div class="page-separator">
                      <div class="page-separator__text">المشاريع المنتهية</div>
                  </div>
                                     ...
                                     <span
                                        ...
                                        class=" card-body d-flex flex-row align-items-center justify-content-start">
                                         ...
                                         <span class="flex d-flex flex-column">
                                             ...
                                             <small class="text-50">المشاريع السابقة</small>
                                         </span>
                                         </span>
                                 </div>
                             </div>
                  ...
                  <div class="page-separator">
                      <div class="page-separator__text">إضافة مشروع جديد</div>
                  </div>
                          ...
                          <div role="group"
                              ...
                              <div class="form-row">
                                  <label id="label-question"
                                         for="question"
                                         class="col-md-3 col-form-label form-label">عنوان المشروع</label>
                                  <div class="col-md-9">
                                      <input type="text"
                                                class="form-control">
                                  </div>
                      ...
                      <div class="list-group-item">
                          <div role="group"
                              ...
                              <div class="form-row">
                                  <label id="label-question"
                                         for="question"
                                         class="col-md-3 col-form-label form-label">وصف المشروع</label>
                                  <div class="col-md-9">
                          ...
                          <div class="list-group-item">
                              <div role="group"
                                  ...
                                  <div class="form-row">
                                      <label id="label-question"
                                             for="question"
                                             class="col-md-3 col-form-label form-label"> الميزانية</label>
                                      <div class="col-md-9">
                                          <input type="number"
                                                    class="form-control">
                                      </div>
                      ...
                      <div class="list-group-item">
                          <div role="group"
                              ...
                              <div class="form-row">
                                  <label id="label-question"
                                         for="question"
                                         class="col-md-3 col-form-label form-label">تاريخ النتهاء</label>
                                  <div class="col-md-9">
                                      <input type="date">
                                  </div>
                              </div>
                      ...
                      <div class="list-group-item">
                          <div class="form-group m-0"
                              ...
                              <div class="form-row align-items-center">
                                  <label id="label-topic"
                                         for="topic"
                                         class="col-md-3 col-form-label form-label">فريق المشروع</label>
                                         <div class="col-9 d-inline-flex align-items-center">
                                         <select name="" class="col-9 js-example-basic-single" id="" multiple >
                      ...
                      <div class="list-group-item">
                          <div class="custom-control custom-checkbox custom-control-inline">
                              <input id="notify"
                                     ...
                                     checked="">
                              <label for="notify"
                                     class="custom-control-label">أرسل لي إشعار عندما يقوم موظف بالتعليق على المشروع</label>
                          </div>

                      </div>
                      <div class="list-group-item">
                          <button type="button"
                                  class="btn btn-accent">نشر المشروع</button>
                      </div>
                  </div>
