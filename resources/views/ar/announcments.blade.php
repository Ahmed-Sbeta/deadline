                                        ...
                                        <div class="list-group-item p-3">
                                            <div class="row align-items-start">
                                                ...
                                                <div class="col mb-8pt mb-md-0">
                                                    <p class="mb-8pt"><a href="announcment-details.html"
                                                ...
                                                <a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu dropd-caret-centerown-menu">
                                                            <a class="dropdown-item"
                                                               href="#">Edit</a>
                                                            <a class="dropdown-item"
                                                               href="#">Delete</a>  </div>
                                            ...
                                            <div class="row align-items-start">
                                                <div class="col-md-3 mb-8pt mb-md-0">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column media-body media-middle">
                                                            <span
                                                               class="text-body"><strong>Adam Curtis</strong></span>
                                                            <small class="text-muted">3 days ago</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-8pt mb-md-0">
                                                    <p class="mb-0"><a href="announcment-details.html"
                                ...
                                <div class="list-group-item">
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input id="notify"
                                               ...
                                               checked="">
                                        <label for="notify"
                                               class="custom-control-label">Notify me on email when someone comment on this Announcment</label>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-lg-0">
                        ...
                        <div class="card-body">
                            <div>
                                <a href="announcment-details.html"><img src="assets/images/quickers.png" alt="Announcment Details"
