                  ...
                  <div class="nav-item dropdown d-none d-sm-flex" >
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a class="dropdown-item"
                             href="/مشروع التخرج/Deadline/Deadline/dist/En/tasks-details.html">EN</a>
                    ...
                    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                         ...
                         <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                             <h2 class="mb-0">تفاصيل المهمة</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-muted d-flex align-items-center mb-lg-32pt">
                                    <a href="tasks-list.html"
                                       class="mr-3">العودة إلى المهام</a>
                                      ...
                                      <span class="avatar avatar-32pt avatar  mr-12pt">
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="d-flex align-items-center">
                                                    <a href="#"
                                                       class="btn btn-sm btn-outline-secondary">Download attachment<i class="icon--right material-icons">file_download</i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex">
                                        <div class="form-group">
                                            <label for="comment"
                                                   class="form-label">الرد الخاص بك</label>
