                    ...
                    <div class="mdk-drawer-layout__content"
                        ...
                        <div class="container-fluid page__container page-section col-sm-9">
                            ...
                            <div class="page-separator">
                                <div class="page-separator__text">رسالة جديدة</div>
                            </div>
                            ...
                            <div class="list-group list-group-form">
                                    ...
                                    <div class="form-group m-0"
                                        ...
                                        <div class="form-row align-items-center">
                                            <label id="label-topic"
                                                   for="topic"
                                                   class="col-md-3 col-form-label form-label">To</label>
                                                   <div class="col-9 d-inline-flex align-items-center">
                                                   <select name="" class="col-md-12 js-example-basic-single" id="" multiple >
                                ...
                                <div class="list-group-item">
                                    <div class="form-group row align-items-center mb-0">
                                        <label class="form-label col-form-label col-sm-3">العنوان</label>
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   class="form-control"
                                ...
                                <div class="list-group-item">
                                    <div class="form-group row align-items-center mb-0">
                                        <label class="form-label col-form-label col-sm-3">محتوى الرسالة</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control"
                                              ...
                                              <div class="d-inline-flex align-items-center">
                                                <a href="#"
                                                   class="btn btn-sm btn-outline-secondary mr-8pt">إرفاق ملف <i class="icon--right material-icons">keyboard_arrow_up</i></a>

                                            </div>
                                        </div>
                                        <p></p>
                                        <button class="btn btn-accent">إرسال الرسالة</button>
                         ...
                         data-perfect-scrollbar>
                               ...
                               <div class="sidebar-account mx-16pt mb-16pt dropdown">
                                   ...
                                   <div class="dropdown-menu dropdown-menu-full dropdown-menu-caret-center">
                                       ...
                                       <a class="dropdown-item"
                                          href="billing-history.html">تاريخ الدفع</a>
                                       <a class="dropdown-item"
