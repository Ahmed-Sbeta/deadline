                    ...
                    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                <h2 class="mb-0">الإشتراك الخاص بك</h2>
                        ...
                        <ul class="nav navbar-nav">
                            <li class="nav-item">
                                <a href="billing-history.html"
                                   class="nav-link text-70"><i class="material-icons icon--left">keyboard_backspace</i> العودة إلى المدفوعات السابقة </a>
                            </li>
                        </ul>
                    </div>
                </nav>
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-6 mb-24pt mb-lg-0">
                                        <p class="text-70 mb-0"><strong>أعدت لأجل </strong></p>
                                        <h2>Yaseen Algiloushi</h2>
                                        <p class="text-50">طريق المطار <br>ليبيا</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p class="text-70 mb-0"><strong>أعدت من قبل </strong></p>
                                        <h2>MAWJA</h2>
                                        <p class="text-50">زاوية الدهماني<br>Register Id 55815</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 text-lg-right d-flex flex-lg-column mb-24pt mb-lg-0 border-bottom border-lg-0 pb-16pt pb-lg-0">
                                <div class="flex">
                                    <p class="text-70 mb-8pt"><strong>فاتورة</strong></p>
                                    <p class="text-50">
                                        9 Jan 2022<br>
                                        10003578
                                    </p>
                                </div>
                                <div><button class="btn btn-accent">تنزيل <i class="material-icons icon--right">file_download</i></button></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9 pr-lg-0">
                                ...
                                <div class="page-section">
                                    ...
                                    <div class="card table-responsive mb-24pt">
                                        <table class="table table-flush table--elevated">
                                            <thead>
                                                <tr>
                                                    <th>وصف</th>
                                                    <th style="width: 60px;"
                                                        class="text-right">القيمة</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <p class="mb-0"><strong>الخطة الرئيسية  - إشتراك شهري</strong></p>
                                                        <p class="text-50">للفترة من إلى June 20, 2018 to July 20, 2018</p>
                                                    </td>
                                                    <td class="text-right"><strong>&dollar;9</strong></td>
                                                </tr>
                                                <tr>
                                                    <td><strong> عرض التخفيض</strong></td>
                                        ...
                                        <table class="table table-flush">
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <td class="text-right text-70"><strong>المجموع</strong></td>
                                                    <td style="width: 60px;"
                                    ...
                                    <div class="px-16pt">
                                        <p class="text-70 mb-8pt"><strong>قمت بدفع الفاتورة</strong></p>
                                        <div class="media">
                                ...
                                <div class="page-section pt-lg-112pt">
                                    <nav class="nav page-nav__menu">
                                        <a class="nav-link"
                                           href="billing.html">الإشتراك</a>
                                        <a class="nav-link"
                                           href="billing-upgrade.html">ترقية الحساب </a>
                                        <a class="nav-link"
                                           href="billing-payment.html"> الدفع</a>
                                        <a class="nav-link"
                                           href="billing-history.html"> المدفوعات السابقة</a>
                                        <a class="nav-link active"
                                           href="billing-invoice.html">الفاتورة</a>
                                    </nav>
