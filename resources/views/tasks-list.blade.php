                    ...
                    <div class="page-section">
                        ...
                        <div class="card mb-lg-32pt">
                            <div class="card-header py-12pt d-flex align-items-center">
                                ...
                                <div class="text-50">{{$opened->count()}}</div>
                                <div class="flex"></div>
                                <a href="#"><i class="material-icons text-20">keyboard_arrow_up</i></a>
                            </div>
                                            ...
                                            <th style="width: 18px;"
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           ...
                                                           data-target="#tasks"
                                                           id="customCheckAll_tasks">
                                                    <label class="custom-control-label"
                                                           for="customCheckAll_tasks"><span class="text-hide">Toggle all</span></label>
                                                </div>
                                            </th>
  ...
  15 <span class="text-50">of 1,430</span> <a href="#" class="text-50"><i class="material-icons ml-1">arrow_forward</i></a>
                        ...
                        <div class="card mb-lg-32pt">
                            <div class="card-header py-12pt d-flex align-items-center">
                                ...
                                <a href="#"
                                   class="d-inline-block mx-16pt"><i class="material-icons text-50">more_horiz</i></a>
                                <div class="text-50">{{$inProgress->count()}}</div>
                                <div class="flex"></div>
                                <a href="#"><i class="material-icons text-20">keyboard_arrow_up</i></a>
                            </div>
                            <div class="progress rounded-0"
                                            ...
                                            <th style="width: 18px;"
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-toggle-check-all"
                                                           data-target="#tasks2"
                                                           id="customCheckAll_tasks2">
                                                    <label class="custom-control-label"
                                                           for="customCheckAll_tasks2"><span class="text-hide">Toggle all</span></label>
                                                </div>
                                            </th>
  ...
  15 <span class="text-50">of 1,430</span> <a href="#" class="text-50"><i class="material-icons ml-1">arrow_forward</i></a>
                        ...
                        <div class="card mb-0 p-relative o-hidden">
                            <div class="card-header py-12pt d-flex align-items-center">
                                ...
                                <a href="#"
                                   class="d-inline-block mx-16pt"><i class="material-icons text-50">more_horiz</i></a>
                                <div class="text-50">{{$closed->count()}}</div>
                                <div class="flex"></div>
                                            ...
                                            <th style="width: 18px;"
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           class="custom-control-input js-toggle-check-all"
                                                           data-target="#tasks2"
                                                           id="customCheckAll_tasks3">
                                                    <label class="custom-control-label"
                                                           for="customCheckAll_tasks3"><span class="text-hide">Toggle all</span></label>
                                                </div>
                                            </th>
                                            ...
                                            <td class="pr-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"
                                                           ...
                                                           value="{{$task->id}}"
                                                           class="custom-control-input js-check-selected-row"
                                                           id="customCheck1_tasks3_{{$k}}">
                                                    <label class="custom-control-label"
                                                           for="customCheck1_tasks3_{{$k++}}"><span class="text-hide">check</span></label>
                                                </div>
                                            </td>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-lg-0">
                                ...
                                <div class="card-body">
                                    <div>
                                        <a href="faq.html"><img src="assets/images/quickers.png" alt="Project Details"
                                             style="width:570px;"></a>
