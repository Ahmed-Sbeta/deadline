										...
										<div class="header-nav-main header-nav-main-font-lg header-nav-main-font-lg-upper-2 header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li class="dropdown">
														<a data-hash class="nav-link active" href="/index">
															Home
														</a>
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">Signup</h1>
							</div>
				...
				@endif
					...
					<div class="row justify-content-center">
						<div class="col-md-12">
							<h2 class="font-weight-bold text-5 mb-0">Company Code <span class="text-color-danger">*</span></h2>
							<br>
							<form action="{{route('addEmployee')}}" id="frmSignIn" method="post" class="needs-validation">
								@csrf
								<div class="card mb-4">
									<div class="card-body">
										<input class="form-control form-control-lg mb-3" name="Code" type="text" placeholder="Enter company code" required>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="form-group col">
										<label class="form-label text-color-dark text-3">Job Title<span class="text-color-danger">*</span></label>
										<input type="text" value="" name="job" class="form-control form-control-lg text-4" placeholder="(Graphic designer,Photographer) as an example" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col">
								...
								<div class="row justify-content-between">
									<div class="form-group col-md-auto">
										<div class="custom-control custom-checkbox">
											...
											<label class="form-label custom-control-label cur-pointer text-2" for="rememberme"></label>
										</div>
									</div>
