						...
						<div class="col-md-12">
					        ...
					        @enderror
								...
								<div class="row justify-content-between">
									...
									<div class="form-group col-md-auto">
										<a class="text-decoration-none text-color-dark text-color-hover-primary font-weight-semibold text-2" href="../Home - En/Lost Password.html">Forgot Password?</a>
									</div>
								</div>
								<div class="row">
					...
					<div class="row justify-content-md-center py-5 mt-3">
						...
						<div class="col-md-6 col-lg-2 text-center text-lg-start mb-5 mb-lg-0">
							...
							<ul class="list list-unstyled">
								<li class="mb-1"><a href="../Home - En/Login.html" class="link-hover-style-1"> Login </a></li>
								<li class="mb-1"><a href="../Home - En/Signup.html" class="link-hover-style-1"> Signup </a></li>
								<li class="mb-1"><a href="../Home - En/Subscribe.html" class="link-hover-style-1"> Subscribe </a></li>
							</ul>
						</div>
