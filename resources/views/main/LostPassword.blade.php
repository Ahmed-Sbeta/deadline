							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="../Home - Ar/index-corporate.html"><img alt="Deadline"  src="img/deadline logo.png"></a>
									</div>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-font-lg header-nav-main-font-lg-upper-2 header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li class="dropdown">
														<a data-hash class="nav-link active" href="../Home - En/index-corporate.html">
															Home
														</a>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">Restore Password</h1>
							</div>
						...
						<div class="col-md-12">
							<div class="featured-box featured-box-primary text-start mt-0">
								<div class="box-content">
									<h4 class="color-primary font-weight-semibold text-4 text-uppercase mb-0">Lost Password?</h4>
									<p class="text-2 opacity-7">Enter your email address below and we'll send you a link to reset your password.</p>
