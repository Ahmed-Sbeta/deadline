										...
										<div class="header-nav-main header-nav-main-font-lg header-nav-main-font-lg-upper-2 header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="/home#about">About</a>
													</li>
													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="/home#features">Features</a>
													</li>
													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="/home#packages">Packages</a>
													</li>
													<li class="dropdown">
													...
													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="/home#clients">Our Clients</a>
													</li>

													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="/home#contact">Contact Us</a>
													</li>
										...
										<div class="header-nav-features order-1 order-lg-2">
											<div class="header-nav-feature header-nav-features-social-icons d-inline-flex">
												<ul class="header-social-icons social-icons d-none d-sm-block social-icons-clean ms-0">
													<li class="social-icons-facebook"><a href="http://www.facebook.com/MAWJA" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
													<li class="social-icons-linkedin"><a href="https://www.linkedin.com/company/mawjaly" target="_blank" title="Linkedin"><i class="fab fa-linkedin-in"></i></a></li>
												</ul>
											</div>
										</div>
									</div>
			...
			<div role="main" class="main">
				...
				<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center dots-light show-dots-hover nav-inside nav-inside-plus nav-dark nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['670px','670px','670px','550px','500px']" style="height: 670px;">
					<div class="owl-stage-outer">
						<div class="owl-stage">
							...
							<!-- Carousel Slide 1 -->
							<div class="owl-item position-relative overlay overlay-color-primary overlay-show overlay-op-8" style="background-image: url(img/slides/slide-corporate-1-1.jpg); background-size: cover; background-position: center;">
									...
									<div class="row justify-content-center align-items-center h-100">
										<div class="col-lg-6">
											<div class="d-flex flex-column align-items-center">
												...
												<p class="text-4 text-color-light font-weight-light text-center mb-0" data-plugin-animated-letters data-plugin-options="{'startDelay': 2000, 'minWindowWidth': 0}">Boost Your Tasks</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="owl-item position-relative overlay overlay-show overlay-op-8" style="background-image: url(img/slides/slide-corporate-1-2.jpg); background-size: cover; background-position: center;">
								<div class="container position-relative z-index-3 h-100">
									<div class="row justify-content-center align-items-center h-100">
										<div class="col-lg-7">
											<div class="d-flex flex-column align-items-center">
												<h2 class="text-color-light font-weight-extra-bold text-13 mb-4 appear-animation" data-appear-animation="blurIn" data-plugin-options="{'minWindowWidth': 0}">Simple Management</h2>
				...
				<div class="home-intro mb-0" id="home-intro">
					<div class="container">
						...
						<div class="row align-items-center">
							<div class="col-lg-8">
								<p>
									The fastest way to grow your business with <span class="highlighted-word highlighted-word-animation-1 text-color-primary font-weight-semibold text-5">DEADLINE</span>
									<span>Check out our Packages and features included.</span>
								</p>
							</div>
							<div class="col-lg-4">
						...
						<div class="row text-center row-md-1">
							<div class="col-md-10 mx-md-auto row-md-1 ">
								...
								<p class="lead appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
                                    Beautifully crafted user interface for modern Business companies that provide multiple services, It helps the management following the proccess of the Project Management, Tasks, Messaging and Account Management.								</p>
							</div>
						</div>
					</div>
				</section>

				<section class="section bg-color-grey-scale-1 section-height-3 border-0 m-0" id="features">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="font-weight-normal text-center text-6 pb-3">Our <strong class="font-weight-extra-bold">Features</strong></h2>
							</div>
						</div>
						<div class="row mb-lg-4">
							<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
								<div class="feature-box feature-box-style-2">
									...
									<div class="feature-box-info">
										...
										<p>Our team will make sure customers are <span class="alternative-font">successful.</span> in solving whatever issues they came to your business to help solve.  we will provide you with responsive, relevant support.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="feature-box feature-box-style-2">
									...
									<div class="feature-box-info">
										<h4 class="font-weight-bold mb-2">Manage Projects</h4>
										<p>Deadline will help you organize your projects by adding,editing and deleting your projects in very easy way with your employees.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
								<div class="feature-box feature-box-style-2">
									...
									<div class="feature-box-info">
										<h4 class="font-weight-bold mb-2">Follow tasks</h4>
										<p>Your supervisors will easily add tasks and follow the workflow with the team to make sure that the work is delievred before <span class="alternative-font">Deadline.</span></p>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
								<div class="feature-box feature-box-style-2">
									...
									<div class="feature-box-info">
										<h4 class="font-weight-bold mb-2">Announcments & Reports</h4>
										<p>Archiving your important documents and your annually,monthly and weekly reports, publish your Announcments in a very easy way ! </p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="feature-box feature-box-style-2">
									...
									<div class="feature-box-info">
										<h4 class="font-weight-bold mb-2">Employees Management</h4>
										<p>Add your team members  <span class="alternative-font">easily.</span> and manage the accounts that will be in your dashboard .</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
								<div class="feature-box feature-box-style-2">
									...
									<div class="feature-box-info">
										<h4 class="font-weight-bold mb-2">Well Designed</h4>
										<p>Beautifully crafted user interface for modern Business companies that provide multiple services.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row counters counters-sm py-4 mt-5">
						<div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
							<div class="counter">
								...
								<strong class="text-color-dark font-weight-extra-bold" data-to="22" data-append="+">0</strong>
						...
						<div class="col-sm-6 col-lg-3 mb-5 mb-sm-0">
							<div class="counter">
								...
								<strong class="text-color-dark font-weight-extra-bold" data-to="1178">0</strong>
								<label class="text-4 mt-1">Total Tasks</label>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
							<div class="counter">
								<i class="icons icon-cup text-color-dark"></i>
								<strong class="text-color-dark font-weight-extra-bold" data-to="21">0</strong>
					...
					<div class="col" id="packages">
						<h1 class="font-weight-normal text-center">Our <strong class="font-weight-extra-bold">Packages</strong></h1>
						<br><br>
					</div>
					...
					<div class="col-md-4">
							<div class="plan">
								...
								<div class="plan-footer">
									<a href="Subscribe.html" class="btn btn-dark btn-modern btn-outline py-2 px-4">Get Start</a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="plan plan-featured">
								...
								<div class="plan-price">
									<span class="price"><span class="price-unit">LYD</span>550</span>
									<label class="price-label">PER MONTH</label>
								</div>
								<div class="plan-features">
									<ul>
								...
								<div class="plan-footer">
									<a href="Subscribe.html" class="btn btn-primary btn-modern py-2 px-4">Get Start</a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="row text-center">
						<div class="col" id="clients">
							<h2 class="font-weight-normal text-6 mt-4">Our <strong class="font-weight-extra-bold">Clients</strong></h2>
						</div>
					</div>
				</div>
								...
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										...
										<span class="thumb-info-title">
											<span class="thumb-info-inner">MAWJA</span>
							...
							<a href="https://LIBYANA.LY">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										...
										<span class="thumb-info-title">
											<span class="thumb-info-inner">LIBYANA</span>
											<span class="thumb-info-type">VISIT</span>
										</span>
										<span class="thumb-info-action">
										</span>
							...
							<a href="https://LIBYANWINGS.LY">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										...
										<span class="thumb-info-title">
											<span class="thumb-info-inner">LIBYAN WINGS</span>
											<span class="thumb-info-type">VISIT</span>
										</span>
										<span class="thumb-info-action">
										</span>
							...
							<a href="https://MARCA.LY">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										...
										<span class="thumb-info-title">
											<span class="thumb-info-inner">MARCA</span>
											<span class="thumb-info-type">VISIT</span>
										</span>
										<span class="thumb-info-action">
										</span>
							...
							<a href="https://al-mada.ly">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										...
										<span class="thumb-info-title">
											<span class="thumb-info-inner">AL-MADA</span>
											<span class="thumb-info-type">VISIT</span>
										</span>
										<span class="thumb-info-action">
										</span>
				...
				<hr class="solid my-5">
					...
					<div class="row text-center">
						<div class="col">
							<h2 class="font-weight-normal text-6 mt-4"><strong class="font-weight-extra-bold">Recommendations</strong></h2>
						</div>
					</div>
								...
								<div class="owl-carousel owl-theme nav-bottom rounded-nav dots-light mb-0" data-plugin-options="{'items': 1, 'loop': false, 'autoHeight': true}">
									<div>
										<div class="col">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes mb-0">
												...
												<div class="testimonial-author">
													<p><strong class="text-2 opacity-10">- Tameem</strong></p>
												</div>
											</div>
										</div>
									</div>
									<div>
										<div class="col">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes mb-0">
												<div class="testimonial-author">
													<img src="/مشروع التخرج/Deadline/Deadline/dist/HTML/img/clients/client-2.jpg" class="img-fluid rounded-circle" alt="">
												</div>
												<blockquote>
												...
												<div class="testimonial-author">
													<p><strong class="text-2 opacity-10">- Haitham</strong></p>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="row text-center">
					<div class="col" id="contact">
						<h1 class="font-weight-normal "><strong class="font-weight-extra-bold">Contact us</strong></h1>
					</div>
				</div>
						...
						<div class="col-lg-6">
							...
							<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
								...
								<ul class="list list-icons list-icons-style-2 mt-2">
									<li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address:</strong> Zawiyat Al-Dahmani, Tripoli-Libya</li>
									<li><i class="fas fa-phone top-6"></i> <strong class="text-dark">Phone:</strong> (218) 92 5160515</li>
									<li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a href="mailto:info@Deadline.ly">info@Deadline.ly</a></li>
								</ul>
							</div>
							...
							<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="950">
								...
								<ul class="list list-icons list-dark mt-2">
									<li><i class="far fa-clock top-6"></i> Sunday - Thursday - 9am to 4pm</li>
									<li><i class="far fa-clock top-6"></i> Saturday - 10am to 2pm</li>
									<li><i class="far fa-clock top-6"></i> Friday - Closed</li>
								</ul>
							</div>

							<h4 class="pt-5">Get in <strong>Touch</strong></h4>
							<p class="lead mb-0 text-4">Feel free to ask for details, don't save any questions!</p>
					...
					<div class="row justify-content-md-center py-5 mt-3">
						...
						<div class="col-md-6 col-lg-2 text-center text-lg-start mb-5 mb-lg-0">
							...
							<ul class="list list-unstyled">
								<li class="mb-1"><a href="Login.html" class="link-hover-style-1"> Login </a></li>
								<li class="mb-1"><a href="Signup.html" class="link-hover-style-1"> Signup </a></li>
								<li class="mb-1"><a href="Subscribe.html" class="link-hover-style-1"> Subscribe </a></li>
							</ul>
						</div>
