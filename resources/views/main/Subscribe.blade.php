...
<html>
	<head>
		...
		<title>Deadline - Subscribe</title>
	...
	<body data-plugin-page-transition>
		...
		<div class="body">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index-corporate.html"><img alt="Deadline"  src="img/deadline logo.png"></a>
									</div>
								</div>
							</div>
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">Subscribe</h1>
							</div>
				...
				<div class="container py-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-12">
							<h2 class="font-weight-bold text-5 mb-0">Company Name <span class="text-color-danger">*</span></h2>
							<br>
							<form action="{{route('addcompany')}}" id="frmSignIn" method="post" class="needs-validation">
								@csrf
								<div class="card mb-4">
									<div class="card-body">
										<input class="form-control form-control-lg mb-3" name="name" type="text" placeholder="Enter Company Name" required>
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" value="" name="firstName" class="form-control form-control-lg text-4" required>
									</div>
									<div class="form-group col-md-6">
										<label class="form-label text-color-dark text-3">Last Name <span class="text-color-danger">*</span></label>
										<input type="text" value="" name="lastName" class="form-control form-control-lg text-4" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col">
										<label class="form-label text-color-dark text-3">Date of Birth<span class="text-color-danger">*</span></label>
										<input type="date" value="" name="dob" class="form-control form-control-lg text-4" required>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group col">
										...
										<input type="email" value="" name="email" class="form-control form-control-lg text-4" required>
									</div>
								</div>
								<div class="row">
									...
									<div class="form-group col-lg-6">
										<label class="form-label">Confirm Password <span class="text-color-danger">*</span></label>
										<input type="password" name="confirmPassword" value="" class="form-control form-control-lg" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-lg-6">
										<label class="form-label">Phone Number <span class="text-color-danger">*</span></label>
										<input type="tel" value="" name="phoneNumber" class="form-control form-control-lg"  required>
									</div>
									<div class="form-group col-lg-6">
										<label class="form-label">Company Location</label>
										<input type="text" value="" name="location" class="form-control form-control-lg" >
									</div>
								</div>
								<div class="row">
									<div class="form-group col">
										<label class="form-label">Package <span class="text-color-danger">*</span></label>
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input class="form-check-input" type="radio" name="subscription" data-msg-required="Please select at least one option." id="tabContent9Radio1" value="1" required> Basic
											</label>
										</div>
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input class="form-check-input" type="radio" name="subscription" data-msg-required="Please select at least one option." id="tabContent9Radio2" value="2" required> Standard
											</label>
										</div>
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input class="form-check-input" type="radio" name="subscription" data-msg-required="Please select at least one option." id="tabContent9Radio3" value="3" required> Premiun
											</label>
										</div>
									</div>
								</div>
								<div class="alert alert-warning">
									<strong>We must tell you!</strong> You have to complete your payment process after completing your registeration information to receive  your <strong> Company Code</strong>
								</div>

								<div class="row">
									<div class="form-group col-md-3">
										<button type="submit" class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3" data-loading-text="Loading...">Signup</button>
			...
			<footer id="footer" class="border-0" style="background:dark ; background-size:cover; background-position: 0 100%;">
				<div class="container py-4">
