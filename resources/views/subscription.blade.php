                            ...
                            <div class="col-lg-9 pr-lg-0">
                                ...
                                <div class="page-section">
                                    ...
                                    <div class="list-group list-group-form">
                                        ...
                                        <div class="list-group-item">
                                            <div class="form-group row mb-0">
                                                <label class="col-form-label col-sm-3">Billing cycle</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="list-group-item">
                                            <div class="form-group row mb-0">
                                                <label class="col-form-label col-sm-3">Payment information</label>
                                                <div class="col-sm-9 d-flex align-items-center">
                                        ...
                                        <div class="list-group-item">
                                            <div class="form-group row mb-0">
                                                <label class="col-form-label col-sm-3">Cancel</label>
                                                <div class="col-sm-9">
                                                    <a href=""
